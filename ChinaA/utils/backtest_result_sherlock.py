...
def get_file_path_and_create_dir(seed, exp, solver, solver_name_prefix, **solver_kwargs):
    return utils.path.get_file_path_and_create_dir(exp, seed+1, solver, solver_name_prefix, **solver_kwargs)
...
def read_single_solver_backtest_result(exp_num, seed, model_config):
    ...
    for exp in range(exp_num):
        file_fmt = get_file_path_and_create_dir(exp, seed, solver, solver_name_prefix, **solver_kwargs)
