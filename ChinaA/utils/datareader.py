...
def load_fama_french_factors(normalized = False):
    market_pct_chg = pd.read_pickle(__project_dir__ + '/factor_returns/market_pct_chg.pkl')
    SMB_pct_chg = pd.read_pickle(__project_dir__ + '/factor_returns/SMB_pct_ret.pkl')
    HML_pct_chg = pd.read_pickle(__project_dir__ + '/factor_returns/HML_pct_ret.pkl')
